...
// It would have been much easier to include getAll method in struct returning list of vars, but
// it is not specified
...
print("I ran a distance of \(firstRun.distance) meters in \(firstRun.time) minutes and elevated \(firstRun.elevation) meters.")
