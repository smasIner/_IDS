...
print("Lat: \(somePlace.latitude)")
print("Long: \(somePlace.longitude)")
...
struct Book {
    ...
    var author: String
    var pages: Int
    var price: Double // In dollars, as info is from Amazon
}
let favoriteBook = Book(title: "Modern Operating Systems", author: "Andrew S. Tenenbaum", pages: 1137, price: 62)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages and it costs $\(favoriteBook.price)")
...
let laptop1 = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2020)
let laptop2 = Laptop(yearPurchased: 2077)
...
let myHeight = Height(heightInCentimeters: 193)
print("My height in centimeters is \(myHeight.heightInCentimeters), whereas my height in inches is \(myHeight.heightInInches)")
/*:
