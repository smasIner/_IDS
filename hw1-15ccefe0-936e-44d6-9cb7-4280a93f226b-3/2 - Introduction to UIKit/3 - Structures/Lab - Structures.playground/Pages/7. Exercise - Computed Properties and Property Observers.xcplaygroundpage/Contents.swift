...
var rect = Rectangle(width: 5, height: 5)
...
var myHeight = Height(heightInCentimeters: 193)
print("My height is cm: \(myHeight.heightInCentimeters), and my height in inches: \(myHeight.heightInInches)")
print("Shrinking process...")
myHeight.heightInCentimeters = 123
print("My New height is cm: \(myHeight.heightInCentimeters), and my height in inches: \(myHeight.heightInInches)")
/*:
